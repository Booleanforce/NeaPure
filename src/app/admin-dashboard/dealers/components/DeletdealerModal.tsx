...
export default function DeleteDealerModal({
  ...
  return (
    <div className="fixed inset-0 z-[999] flex items-center justify-center bg-blue-950/40 p-4 backdrop-blur-sm">

      <div className="w-full max-w-md overflow-hidden rounded-2xl bg-white shadow-2xl shadow-blue-900/20">
        ...
        <div className="bg-blue-50/40 px-4 py-5 sm:px-6 sm:py-6">
          ...
          <p className="text-sm leading-6 text-slate-600">
            ...
            <br />
            The dealer will be removed from the dealer list.
          </p>
